...
class BaseController{
	...
	function __construct(){
		...
		$this->file_upload_settings['file_proposal'] = array(
			"title" => "{{random}}",
			"extensions" => "",
			"limit" => "1",
			"filesize" => "3",
		...
		$this->file_upload_settings['foto_inovasi'] = array(
			"title" => "{{random}}",
			"extensions" => "",
			"limit" => "1",
			"filesize" => "2",
		...
		$this->file_upload_settings['video_inovasi'] = array(
			"title" => "{{random}}",
			"extensions" => "",
			"limit" => "1",
			"filesize" => "10",
		...
		$this->file_upload_settings['dokument_file_inovasi'] = array(
			"title" => "{{random}}",
			"extensions" => "",
			"limit" => "1",
			"filesize" => "2",
