                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="form-group ">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <input id="ctrl-no_handphone"  value="<?php  echo $data['no_handphone']; ?>" type="text" placeholder="Enter No Handphone"  required="" name="no_handphone"  class="form-control " />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group ">
                                                ...
                                                <div class="form-group ">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <div class="">
                                                                <input id="ctrl-pekerjaan_saat_ini"  value="<?php  echo $data['pekerjaan_saat_ini']; ?>" type="text" placeholder="Enter Pekerjaan Saat Ini"  required="" name="pekerjaan_saat_ini"  class="form-control " />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
