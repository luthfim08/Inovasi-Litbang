                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <input id="ctrl-tahun_lulus"  value="<?php  echo $this->set_field_value('tahun_lulus',""); ?>" type="text" placeholder="Enter Tahun Lulus"  required="" name="tahun_lulus"  class="form-control " />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
