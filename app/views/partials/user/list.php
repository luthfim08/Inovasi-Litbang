                                    ...
                                    <table class="table  table-striped table-sm text-left">
                                        <thead class="table-header bg-light">
                                            <tr>
                                                ...
                                                <th  class="td-tahun_lulus"> Tahun Lulus</th>
                                                <th  class="td-jurusan"> Jurusan</th>
                                                <th  class="td-email"> Email</th>
                                                <th  class="td-no_handphone"> No Handphone</th>
                                                <th  class="td-alamat"> Alamat</th>
                                                <th  class="td-pekerjaan_saat_ini"> Pekerjaan Saat Ini</th>
                                        ...
                                        <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                            ...
                                            <tr>
                                                ...
                                                <th class=" td-checkbox">
                                                    ...
                                                    <td class="td-no_handphone"><a href="<?php print_link("tel:$data[no_handphone]") ?>"><?php echo $data['no_handphone']; ?></a></td>
                                                    <td class="td-alamat">
                                                    ...
                                                    <td class="td-pekerjaan_saat_ini">
