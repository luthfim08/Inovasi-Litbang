                                    ...
                                    <div class="form-group ">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="input-group">
                                                    <input id="ctrl-tahun_lulus" class="form-control datepicker  datepicker"  required="" value="<?php  echo $this->set_field_value('tahun_lulus',date_now()); ?>" type="datetime" name="tahun_lulus" placeholder="Enter Tahun Lulus" data-enable-time="false" data-min-date="" data-max-date="" data-date-format="Y-m-d" data-alt-format="d-m-Y" data-inline="false" data-no-calendar="false" data-mode="single" />
                                        ...
                                        <div class="form-group ">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <select required=""  id="ctrl-jurusan" name="jurusan"  placeholder="Select a value ..."    class="custom-select" >
                                                            <option value="">Select a value ...</option>
                                                            <?php 
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="form-group ">
                                                    <div class="row">
                                                        <div class="col-sm-4">
                                                            <label class="control-label" for="no_handphone">No Handphone <span class="text-danger">*</span></label>
                                                        </div>
                                                        <div class="col-sm-8">
                                                            <div class="">
                                                                <input id="ctrl-no_handphone"  value="<?php  echo $this->set_field_value('no_handphone',""); ?>" type="text" placeholder="Enter No Handphone"  required="" name="no_handphone"  class="form-control " />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group ">
                                                        ...
                                                        <div class="form-group ">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <div class="">
                                                                        <input id="ctrl-pekerjaan_saat_ini"  value="<?php  echo $this->set_field_value('pekerjaan_saat_ini',""); ?>" type="text" placeholder="Enter Pekerjaan Saat Ini"  required="" name="pekerjaan_saat_ini"  class="form-control " />
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
