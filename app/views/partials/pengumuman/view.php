                        ...
                        <div id="page-report-body" class="">
                            <table class="table table-hover table-borderless table-striped">
                                ...
                                <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                    <tr  class="td-id_pengumuman">
                                        <th class="title"> Id Pengumuman: </th>
                                        <td class="value"> <?php echo $data['id_pengumuman']; ?></td>
                                    </tr>
                                    <tr  class="td-isi_pengumuman">
                                        <th class="title"> Isi Pengumuman: </th>
                                        <td class="value">
                                            <span <?php if($can_edit){ ?> data-value="<?php echo $data['isi_pengumuman']; ?>" 
