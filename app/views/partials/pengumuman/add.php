                            ...
                            <div>
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-isi_pengumuman"  value="<?php  echo $this->set_field_value('isi_pengumuman',""); ?>" type="text" placeholder="Enter Isi Pengumuman"  required="" name="isi_pengumuman"  class="form-control " />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
