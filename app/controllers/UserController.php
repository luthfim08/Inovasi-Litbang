...
class UserController extends SecureController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		if(!empty($request->search)){
			...
			$search_condition = "(
				...
				user.nama LIKE ? OR 
				user.jenis_kelamin LIKE ? OR 
				user.tahun_lulus LIKE ? OR 
				user.jurusan LIKE ? OR 
				user.email LIKE ? OR 
				user.password LIKE ? OR 
				user.no_handphone LIKE ? OR 
				user.alamat LIKE ? OR 
				user.pekerjaan_saat_ini LIKE ? OR 
				user.photo LIKE ? OR 
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("nama","jenis_kelamin","tahun_lulus","jurusan","email","password","no_handphone","alamat","pekerjaan_saat_ini","photo","account_status","user_role_id");
			...
			$modeldata['password'] = $this->modeldata['password'] = hash( 'sha512' , $password_text );
	...
	function edit($rec_id = null, $formdata = null){
		...
		$tablename = $this->tablename;
		 //editable fields
		$fields = $this->fields = array("id_user","nama","jenis_kelamin","tahun_lulus","jurusan","no_handphone","alamat","pekerjaan_saat_ini","photo","account_status","user_role_id");
		if($formdata){
			$postdata = $this->format_request_data($formdata);
			$this->rules_array = array(
				'nama' => 'required',
