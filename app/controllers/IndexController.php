...
class IndexController extends BaseController{
	...
	function register($formdata = null){
		if($formdata){
			...
			$db = $this->GetModel();
			$tablename = $this->tablename;
			$fields = $this->fields = array("nama","jenis_kelamin","tahun_lulus","jurusan","email","password","no_handphone","alamat","pekerjaan_saat_ini","photo","account_status"); //registration fields
